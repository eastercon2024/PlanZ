...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <div class="container">
            <div class="alert alert-danger mt-3">Unable to create account.</div>
            <div class="card">
                <div class="card-body">
                    <p>This problem may be due to one of the following reasons:</p>
                    <ul>
                        <li>The create account link has expired.</li>
                        <li>The create account link has been used already.</li>
                        <li>A new password reset link has been requested for this user.</li>
                        <li>The create account link was incomplete or modified.</li>
                    </ul>
                </div>
